            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                               <select id="" name="title" class="box" required>
                               <option value ="Monday at Consultation Room 1 ">Monday at Consultation Room 1</option>
                               <option value ="Tuesday at Consultation Room 2">Tuesday at Consultation Room 2</option>    
                               <option value ="Wednesday at Consultation Room 3">Wednesday at Consultation Room 3</option>     
                               <option value ="Thursday at Consultation Room 1">Thursday at Consultation Room 1</option>    
                               <option value ="Friday at Consultation Room 2"> Friday at Consultattion Room 2</option>   
                                </select>
                                </td>
                            </tr>
                            <tr>
